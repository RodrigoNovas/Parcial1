...
{
    int i;
    char nombres[][20]= {"Giovanni","Joaquin","Famis","Rodrigo"};
    char lugar[][20]= {"sansi","tucuman","frapar","godinez"};
    int tipo[]= {1,2,3};
 ...
 * \return void
 */
void orquesta_admin(eOrquesta* orquestas,int cantidad)
{
    int opcion,idAux;
    ...
    do
    {
        ...
        case 3://BAJA EMPLEADO
            ...
            orquesta_listar(orquestas,cantidad);
            idAux=getValidIntOpcion("\nINGRESE ID DE ORQUESTA A DAR DE BAJA\n","\tERROR\nOPCION NO VALIDA\n",1,cantidad);
